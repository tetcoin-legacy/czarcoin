    ...
    ui(new Ui::VerifyMessageDialog)
{
    ...
    ui->lnAddress->setPlaceholderText(tr("Enter a Czarcoin address (e.g. Ler4HNAEfwYhBmGXcFP2Po1NpRUEiK8km2)"));
    ui->lnSig->setPlaceholderText(tr("Enter Czarcoin signature"));
#endif
