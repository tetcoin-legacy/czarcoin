...
uint256 hashGenesisBlock("0x5174015f0852af7f62c7f92bd5816facb31580706282580c2b6d82b815aba2de");
...
static const int64 nTargetTimespan = 240000000; // Czarcoin: 4 minutes
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal czarcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
	uiInterface.ThreadSafeMessageBox(strMessage, "Czarcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // block.nNonce = 2085290533
	// block.GetHash = 5174015f0852af7f62c7f92bd5816facb31580706282580c2b6d82b815aba2de
	// CBlock(hash=5174015f0852af7f62c7, PoW=000002be5a80d5a7f856, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=340651462c, nTime=1413169227, nBits=1e0ffff0, nNonce=2085290533, vtx=1)
...
unsigned char pchMessageStart[4] = { 0x43, 0x7a, 0x61, 0x72 }; // Czarcoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Czarcoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
